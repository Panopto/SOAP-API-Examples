<?php
/**
 * File for class SessionManagementStructGetFoldersById
 ...
 */
/**
 * This class stands for SessionManagementStructGetFoldersById originally named GetFoldersById
 * Meta informations extracted from the WSDL
 * - from schema : {@link http://scratch.beta.panopto.com/Panopto/PublicAPI/4.6/SessionManagement.svc?xsd=xsd0}
 * @package SessionManagement
 * @subpackage Structs
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2017-01-19
 */
class SessionManagementStructGetFoldersById extends SessionManagementWsdlClass
{
    /**
     * The auth
     * Meta informations extracted from the WSDL
